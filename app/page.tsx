...
export default function Home() {
  ...
  return (
    ...
    >
      {/* ============================================================
          GLOBAL STYLES (injected inline so the file is self-contained)
      ============================================================ */}
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Radial glow helper */
        .glow-royal  { box-shadow: 0 0 40px rgba(108,59,255,0.35); }
        .glow-gold   { box-shadow: 0 0 40px rgba(201,151,58,0.3); }
        .glow-cerulean { box-shadow: 0 0 40px rgba(14,165,233,0.3); }
        ...
        .shimmer {
          background: linear-gradient(90deg, var(--cerulean) 0%, #fff 40%, var(--cerulean) 60%);
      ...
      <section ref={heroRef} style={{ position:"relative", width:"100%", minHeight:"100vh", display:"flex", alignItems:"center", overflow:"hidden" }}>
        ...
        <motion.div style={{ y: heroBgY, opacity: heroOpacity, position:"absolute", inset:0, zIndex:0 }}>
          ...
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(to right, rgba(5,3,15,1) 0%, rgba(5,3,15,0.7) 50%, rgba(5,3,15,0.4) 100%)" }} />
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(to top, rgba(5,3,15,1) 0%, transparent 60%)" }} />
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(135deg, rgba(14,165,233,0.15) 0%, transparent 60%)" }} />
        </motion.div>
        ...
        <div style={{ position:"relative", zIndex:10, maxWidth:1400, margin:"0 auto", padding:"0 2rem", paddingTop:120, paddingBottom:80, width:"100%" }}>
          <motion.div variants={STAGGER.container} initial="hidden" animate="show">
            ...
            <motion.div variants={STAGGER.item}>
              ...
              <div style={{ width:160, height:3, background:"linear-gradient(90deg, var(--cerulean) 0%, transparent 100%)", marginTop:16, marginBottom:32, borderRadius:2 }} />
            </motion.div>

            {/* Tagline */}
            <motion.p variants={STAGGER.item} style={{
              fontFamily:"'DM Sans'", fontWeight:300, fontSize:"clamp(14px, 1.5vw, 18px)",
            ...
            <motion.div variants={STAGGER.item} style={{ display:"flex", flexWrap:"wrap", gap:14, alignItems:"center" }}>
              <Link href="/read" style={{ textDecoration:"none" }}>
                <div style={{
                  ...
                  boxShadow:"0 0 40px rgba(108,59,255,0.5), inset 0 1px 0 rgba(255,255,255,0.15)",
                  cursor:"pointer", transition:"all 0.3s ease"
                }}
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "scale(1.04) translateY(-2px)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 50px rgba(108,59,255,0.6), inset 0 1px 0 rgba(255,255,255,0.2)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "scale(1) translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 0 40px rgba(108,59,255,0.5), inset 0 1px 0 rgba(255,255,255,0.15)"; }}
                >
              ...
              <Link href="/wiki" style={{ textDecoration:"none" }}>
                <div style={{
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "rgba(14,165,233,0.15)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(14,165,233,0.8)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "rgba(14,165,233,0.07)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(14,165,233,0.5)"; }}
                >
            ...
            {/* Stat row */}
            <motion.div variants={STAGGER.item} style={{ display:"flex", gap:40, marginTop:60, paddingTop:36, borderTop:"1px solid rgba(255,255,255,0.07)" }}>
              {[["2", "Ongoing Series"], ["47+", "Chapters"], ["∞", "Pages of Lore"]].map(([num, label]) => (
                <div key={label}>
                  <div style={{ fontFamily:"'Bebas Neue'", fontSize:40, lineHeight:1, color:"#fff", letterSpacing:"0.04em" }}>{num}</div>
                  <div style={{ fontFamily:"'DM Sans'", fontSize:10, letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(255,255,255,0.35)", marginTop:4 }}>{label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <AnimatePresence>
        {latestRead && (
          <motion.div initial={{ opacity:0, y:-30 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.6 }}
            style={{ maxWidth:1400, margin:"0 auto", padding:"0 2rem", marginTop:-60, position:"relative", zIndex:20 }}
          >
            <Link href={`/read/${latestRead.chapter}?manga=${latestRead.mangaId}&page=${latestRead.page || 0}`} style={{ textDecoration:"none" }}>
              <div style={{
                ...
                gap:20, padding:"24px 32px", borderRadius:20,
                ...
                boxShadow:"0 8px 40px rgba(108,59,255,0.15), inset 0 1px 0 rgba(255,255,255,0.06)",
                cursor:"pointer", transition:"all 0.4s ease"
              }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(108,59,255,0.7)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 16px 60px rgba(108,59,255,0.25)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(108,59,255,0.35)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 40px rgba(108,59,255,0.15)"; }}
              >
                ...
                <div style={{ display:"flex", alignItems:"center", gap:18 }}>
                  ...
                  <div>
                    <span style={{ fontFamily:"'DM Sans'", fontWeight:700, fontSize:9, letterSpacing:"0.3em", textTransform:"uppercase", color:"var(--cerulean)", display:"block", marginBottom:5 }}>Continue Reading</span>
                    <h4 style={{ fontFamily:"'Bebas Neue'", fontSize:22, letterSpacing:"0.05em", color:"#fff", margin:0 }}>
                      {latestRead.title} <span style={{ color:"rgba(255,255,255,0.4)", fontSize:16, fontFamily:"'DM Sans'", fontWeight:400, letterSpacing:0 }}>Ch. {latestRead.chapter}</span>
                    </h4>
                  </div>
                </div>
                <div style={{
      ...
      {/* ============================================================
          DIVIDER
      ============================================================ */}
      <div style={{ maxWidth:1400, margin:"80px auto 0", padding:"0 2rem" }}>
      ...
      {/* ============================================================
          SECTION HEADER
      ============================================================ */}
      <section style={{ maxWidth:1400, margin:"0 auto", padding:"60px 2rem 40px" }}>
        <div style={{ display:"flex", flexWrap:"wrap", alignItems:"flex-end", justifyContent:"space-between", gap:20, marginBottom:56 }}>
          <div>
            <p style={{ fontFamily:"'DM Sans'", fontWeight:700, fontSize:10, letterSpacing:"0.35em", textTransform:"uppercase", color:"var(--cerulean)", marginBottom:10 }}>The Library</p>
            <h2 style={{ fontFamily:"'Bebas Neue'", fontSize:"clamp(48px, 6vw, 80px)", letterSpacing:"0.04em", lineHeight:0.9, color:"#fff", margin:0 }}>The Archives</h2>
          </div>
          ...
          >
            <Shield size={13} /> Licensing & Terms
          </Link>
        </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(12, 1fr)", gridTemplateRows:"auto", gap:20 }}>
            ...
            <Link href="/read?manga=1" style={{ textDecoration:"none", display:"block" }}>
              ...
              >
                ...
                <div style={{ position:"absolute", top:28, left:28, display:"flex", gap:10 }}>
                  <span style={{ padding:"6px 14px", borderRadius:8, background:"rgba(14,165,233,0.9)", fontFamily:"'DM Sans'", fontWeight:800, fontSize:9, letterSpacing:"0.2em", textTransform:"uppercase", color:"#000" }}>Flagship Release</span>
                  <span style={{ padding:"6px 14px", borderRadius:8, background:"rgba(255,255,255,0.1)", backdropFilter:"blur(10px)", border:"1px solid rgba(255,255,255,0.15)", fontFamily:"'DM Sans'", fontWeight:700, fontSize:9, letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(255,255,255,0.7)" }}>Supernatural</span>
                </div>

                {/* Rating stars */}
                <div style={{ position:"absolute", top:28, right:28, display:"flex", gap:3 }}>
                  {[1,2,3,4,5].map(i => <Star key={i} size={12} fill="var(--cerulean)" color="var(--cerulean)" />)}
                </div>
          ...
          >
            <Link href="/novel" style={{ textDecoration:"none", display:"block", height:"100%" }}>
              ...
              >
                ...
                <div style={{ padding:36, display:"flex", flexDirection:"column", height:"100%", minHeight:460, justifyContent:"space-between", position:"relative", zIndex:2 }}>
                  <div>
          ...
          {/* ── URITHI (Moved to secondary 5-col spot) ── */}
          <motion.div
            ...
            <Link href="/read?manga=2" style={{ textDecoration:"none", display:"block" }}>
              ...
              >
                ...
                <div style={{ position:"absolute", top:24, right:24, display:"flex", alignItems:"center", gap:8 }}>
                  ...
                  <span style={{ fontFamily:"'DM Sans'", fontWeight:700, fontSize:9, letterSpacing:"0.25em", textTransform:"uppercase", color:"var(--gold)" }}>Live Series</span>
                </div>
          ...
          >
            ...
            <Link href="/wiki" style={{ textDecoration:"none" }}>
              <div className="border-animate grain" style={{
                ...
                minHeight:180, cursor:"pointer", padding:32,
                display:"flex", flexDirection:"column", justifyContent:"space-between",
                border:"1px solid rgba(255,255,255,0.07)",
                background:"rgba(255,255,255,0.03)",
                transition:"transform 0.4s ease, border-color 0.4s ease"
              }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-4px)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.2)"; }}
            ...
            {/* One-Shots (Classified) */}
            <div style={{
              position:"relative", borderRadius:24, overflow:"hidden",
              minHeight:180, padding:32, cursor:"not-allowed", opacity:0.5,
              display:"flex", flexDirection:"column", justifyContent:"space-between",
              border:"1px solid rgba(255,255,255,0.05)",
              background:"rgba(255,255,255,0.02)"
            }}>
              <div style={{ position:"absolute", top:16, right:16 }}>
                <div style={{ display:"flex", alignItems:"center", gap:6, padding:"4px 10px", borderRadius:6, border:"1px solid rgba(255,255,255,0.1)", background:"rgba(0,0,0,0.3)" }}>
                  <Shield size={9} style={{ color:"rgba(255,255,255,0.4)" }} />
                  <span style={{ fontFamily:"'DM Sans'", fontWeight:700, fontSize:8, letterSpacing:"0.25em", textTransform:"uppercase", color:"rgba(255,255,255,0.4)" }}>Classified</span>
                </div>
              </div>
              <Zap size={28} style={{ color:"rgba(255,255,255,0.2)", marginBottom:20 }} />
              <div>
                <h4 style={{ fontFamily:"'Bebas Neue'", fontSize:28, letterSpacing:"0.04em", color:"#fff", marginBottom:4 }}>One-Shots</h4>
                <p style={{ fontFamily:"'DM Sans'", fontWeight:600, fontSize:9, letterSpacing:"0.25em", textTransform:"uppercase", color:"rgba(255,255,255,0.2)" }}>Coming Soon</p>
              </div>
            </div>
          ...
          {Array(4).fill(0).map((_, i) => (
            <div key={i} style={{ display:"flex", gap:60, alignItems:"center" }}>
              {["Spectral Rift", "Urithi", "Tales of the 47", "Cyberpunk", "Supernatural", "Crafted in Kenya", "New Chapter Out"].map(t => (
                <span key={t} style={{ fontFamily:"'Bebas Neue'", fontSize:18, letterSpacing:"0.2em", color:"rgba(255,255,255,0.15)" }}>
      ...
      {/* ============================================================
          FOOTER
      ============================================================ */}
      <footer style={{ padding:"60px 2rem 40px", borderTop:"1px solid rgba(255,255,255,0.05)", position:"relative", zIndex:10 }}>
        <div style={{ maxWidth:1400, margin:"0 auto" }}>
            ...
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:16 }}>
                <div style={{
                  ...
                  background:"linear-gradient(135deg, var(--royal) 0%, var(--sapphire) 100%)",
                  display:"flex", alignItems:"center", justifyContent:"center",
                  fontFamily:"'Cinzel'", fontWeight:900, fontSize:20, color:"#fff",
                  boxShadow:"0 0 20px rgba(108,59,255,0.4)"
                }}>J</div>
                <span style={{ fontFamily:"'Cinzel'", fontWeight:700, fontSize:16, letterSpacing:"0.15em", textTransform:"uppercase", color:"#fff" }}>Jody-Verse</span>
              </div>
              <p style={{ fontFamily:"'DM Sans'", fontWeight:300, fontSize:13, color:"rgba(255,255,255,0.35)", maxWidth:280, lineHeight:1.7 }}>A world built in Kenya. Stories that transcend borders.</p>
            </div>
              ...
              <div>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                  {[["Manga", "/read"], ["Novels", "/novel"], ["Wiki", "/wiki"]].map(([l,h]) => (
                    <Link key={l} href={h} style={{ fontFamily:"'DM Sans'", fontWeight:400, fontSize:13, color:"rgba(255,255,255,0.4)", textDecoration:"none", transition:"color 0.3s" }}
                      onMouseEnter={e => (e.currentTarget.style.color = "#fff")}
          ...
          <div style={{ display:"flex", flexWrap:"wrap", justifyContent:"space-between", gap:16, alignItems:"center" }}>
            <p style={{ fontFamily:"'DM Sans'", fontWeight:400, fontSize:11, color:"rgba(255,255,255,0.2)", letterSpacing:"0.1em" }}>
              &copy; {new Date().getFullYear()} Jody-verse. All rights reserved.
            </p>
            <p style={{ fontFamily:"'DM Sans'", fontWeight:600, fontSize:11, color:"rgba(255,255,255,0.2)", letterSpacing:"0.1em" }}>
              Crafted in Kenya 🇰🇪
            </p>
          </div>
        </div>
